...
(7, 1, 'Hey', '/hei/', '嘿', '♪ Hey, boy', 0),
(8, 1, 'boy', '/boi/', '男孩', '♪ Hey, boy', 0),
(9, 1, 'Look', '/luk/', '看著', '♪ Look, I\'m gonna make this simple for you', 0),
(10, 1, 'simple', '/sim-pl/', '簡單的', '♪ Look, I\'m gonna make this simple for you', 0),
(11, 1, 'choices', '/choi-siz/', '選擇', '♪ You got two choices', 0),
(12, 1, 'yes', '/yes/', '是、好', '♪ Yes or yes?', 0),
(13, 1, '둘', '/dul/', '兩個', '♪ 둘 중에 하나만 골라 yes or yes?', 0),
(14, 1, '중에', '/jung-e/', '之中', '♪ 둘 중에 하나만 골라 yes or yes?', 1),
(15, 1, '하나만', '/ha-na-man/', '只有一個', '♪ 둘 중에 하나만 골라 yes or yes?', 1),
(16, 1, '골라', '/gol-la/', '挑選', '♪ 둘 중에 하나만 골la yes or yes?', 0),
(17, 1, '선택해', '/seon-taek-hae/', '選擇', '♪ 하나만 선택해 어서 yes or yes?', 0),
(18, 1, '어서', '/eo-seo/', '快點', '♪ 하나만 선택해 어서 yes or yes?', 0),
(19, 1, '내가', '/nae-ga/', '我', '♪ 내가 이렇게도 이기적이었던가', 0),
(20, 1, '이렇게도', '/i-reo-ke-do/', '這樣地', '♪ 내가 이렇게도 이기적이었던가', 0),
(21, 1, '이기적', '/i-gi-jeok/', '自私的', '♪ 내가 이렇게도 이기적이었던가', 1),
(22, 1, '뭔가', '/mwon-ga/', '什麼', '♪ 뭔가 이렇게 갖고 싶던 적 있었나', 0),
(23, 1, '갖고', '/gat-go/', '擁有', '♪ 뭔가 이렇게 갖고 싶던 적 있었나', 1),
(24, 1, '싶던', '/sip-deon/', '想要', '♪ 뭔가 IQ 這樣 갖고 싶던 적 있었나', 0),
(25, 1, '적', '/jeok/', '經驗、時候', '♪ 뭔가 이렇게 갖고 싶던 적 있었나', 0),
(26, 1, '있었나', '/iss-eot-na/', '有過嗎', '♪ 뭔가 이렇게 갖고 싶던 적 있었나', 0),
(27, 1, '놀拉', '/nol-la/', '驚訝', '♪ 다 놀라 내 뻔뻔함에', 0),
(28, 1, '뻔뻔함에', '/ppeon-ppeon-ham-e/', '厚臉皮', '♪ 다 놀라 내 뻔뻔함에', 1),
(29, 1, '생각보다', '/saeng-gak-bo-da/', '比想像中', '♪ 생각보다 과감해진 나의 시나리오', 0),
(30, 1, '과감해진', '/gwa-gam-hae-jin/', '變得果敢', '♪ 與其想像過度果敢的 나의 시나리오', 0),
(31, 1, '나의', '/na-ui/', '我的', '♪ 생각보다 과감해진 나의 시나리오', 0),
(32, 1, '시나리오', '/si-na-ri-o/', '劇本', '♪ 想得比過於果敢的 나의 시나리오', 0),
(33, 1, '정도', '/jeong-do/', '程度', '♪ 이 정도 plan이면 완벽해', 0),
(34, 1, '완벽해', '/wan-byeok-hae/', '完美', '♪ 이 정도 plan이면 완벽해', 0),
(35, 1, '만족해', '/man-jok-hae/', '滿意', '♪ 만족해 (만족해)', 0),
(36, 1, '누가', '/nu-ga/', '誰', '♪ 누가 뭐래도 ooh', 0),
(37, 1, '뭐래도', '/mwo-rae-do/', '說什麼', '♪ 누가 與其這樣說 ooh', 0),
(38, 1, '맘은', '/mam-eun/', '心是', '♪ 내 맘은 정했어 yes', 0),
(39, 1, '정했어', '/jeong-haess-eo/', '決定了', '♪ 내 맘은 定了 yes', 0),
(40, 1, '그럼', '/geu-reom/', '那麼', '♪ 그럼 이제 니 대답을 들을 차례', 0),
(41, 1, '이제', '/i-je/', '現在', '♪ 那麼 現在 聽你的回答的順序', 0),
(42, 1, '니', '/ni/', '你', '♪ 那麼 現在 聽你的回答的順序', 0),
(43, 1, '대답을', '/dae-dab-eul/', '回答', '♪ 那麼 現在 聽你的回答的順序', 0),
(44, 1, '들을', '/deul-eul/', '聽', '♪ 那麼 現在 聽你的回答的順序', 0),
(45, 1, '차례', '/cha-rye/', '輪到、順序', '♪  那就現在輪到聽你的回答', 0),
(46, 1, '힘들면', '/him-deul-myeon/', '覺得累的話', '♪ 累的話 給你選項', 0),
(47, 1, '보기를', '/bo-gi-reul/', '選項', '♪ 累的話 給你選項', 0),
(48, 1, '줄게', '/jul-ge/', '給你', '♪ 累的話 給你選項', 0),
(49, 1, '넌', '/neon/', '你', '♪ 넌 고르기만 해', 0),
(50, 1, '고르기만', '/go-reu-gi-man/', '只要挑選', '♪ 你只要選就好', 0),
(51, 1, '해', '/hae/', '做', '♪ 你只要選就好', 0),
(52, 1, '고민할', '/go-min-hal/', '煩惱', '♪ 讓你連煩惱的必要也沒有', 0),
(53, 1, '필요도', '/pil-yo-do/', '需要也', '♪ 讓你連煩惱的必要也沒有', 0),
(54, 1, '없게', '/eop-ge/', '沒有', '♪ 讓你連煩惱的必要也沒有', 0),
(55, 1, '해줄게', '/hae-jul-ge/', '會讓你', '♪ 讓你連煩惱的必要也沒有', 0),
(56, 1, '뭘', '/mwol/', '什麼', '♪ 不知道要選什麼 準備了一下', 0),
(57, 1, '고를지', '/go-reul-ji/', '要選什麼', '♪  不知道要選什麼 準備了一下', 0),
(58, 1, '몰ら', '/mol-la/', '不知道', '♪  不知道要選什麼 準備了一下', 0),
(59, 1, '준비해', '/jun-bi-hae/', '準備了', '♪  不知道要選什麼 準備了一下', 0),
(60, 1, '봤어', '/bwas-eo/', '試試看', '♪  不知道要選什麼 準備了一下', 0),
(61, 1, '싫어', '/sil-eo/', '討厭、不要', '♪ \"싫어\"是討厭', 0),
(62, 1, '아니면', '/a-ni-myeon/', '不然', '♪ 不是我就是我們?', 0),
(63, 1, '우리', '/u-ri/', '我們', '♪ 不是我就是我們?', 0),
(64, 1, '선택을', '/seon-taek-eul/', '選擇', '♪ 尊重選擇', 0),
(65, 1, '존중해', '/jon-jung-hae/', '尊重', '♪ 尊重選擇', 0),
(66, 1, '거절은', '/geo-jeol-eun/', '拒絕', '♪ 拒絕就是拒絕', 0),
(67, 1, '거절해', '/geo-jeol-hae/', '拒絕', '♪ 拒絕就是拒絕', 0),
(68, 1, '선택지는', '/seon-taek-ji-neun/', '選項', '♪ 選項只有一個', 0),
(69, 1, '하나', '/ha-na/', '一個', '♪ 選項只有一個', 0),
(70, 1, '자', '/ja/', '來吧(語氣詞)', '♪ 來吧，選擇由你心', 0),
(71, 1, '맘', '/mam/', '心意', '♪ 來吧，選擇由你心', 0),
(72, 1, '진심일까', '/jin-sim-il-kka/', '是真心的嗎', '♪ 真心嗎? Do not guess', 0),
(73, 1, '진심이니', '/jin-sim-i-ni/', '是真心的嗎', '♪ 是真心嗎? Do not ask', 0),
(74, 1, '애매한', '/ae-mae-han/', '曖昧的', '♪ 不要曖昧的左右', 0),
(75, 1, '좌우', '/jwa-u/', '左右', '♪ 不要曖昧的左右', 0),
(76, 1, '말고', '/mal-go/', '不要', '♪ 不要曖昧的左右', 0),
(77, 1, '확실히', '/hwak-sil-hi/', '確實地', '♪ 確實地上下', 0),
(78, 1, '위아래ろ', '/wi-a-rae-ro/', '上下地', '♪ 確實地上下', 0),
(79, 1, '지워버릴래', '/ji-wo-beo-ril-lae/', '要全部擦掉', '♪ 從今天起全部擦掉', 0),
(80, 1, '오늘부로', '/o-neul-bu-ro/', '從今天起', '♪ 從今天起全部擦掉', 0),
(81, 1, '복잡하게', '/bok-jap-ha-ge/', '複雜地', '♪ 複雜地煩惱的必要', 0),
(82, 1, '없어', '/eop-seo/', '沒有', '♪ 沒有 正確答案是 yes, yes, yo', 0),
(83, 1, '정답은', '/jeong-dab-eun/', '正確答案', '♪  沒有 正確答案是 yes, yes, yo', 0),
(84, 1, '없던', '/eop-deon/', '原本沒有的', '♪ 連原本沒有的自私心都刺激的你的眼睛', 0),
(85, 1, '이기심도', '/i-gi-sim-do/', '自私心也', '♪ 連原本沒有的自私心都刺激的你的眼睛', 0),
(86, 1, '자극하는', '/ja-geuk-ha-neun/', '刺激的', '♪ 連原本沒有的自私心都刺激的你的眼睛', 0),
(87, 1, '눈과', '/nun-gwa/', '眼睛與', '♪ 連原本沒有的自私心都刺激的你的眼睛', 0),
(88, 1, '향한', '/hyang-han/', '向著', '♪ 向著你的好奇心相遇', 0),
(89, 1, '호기심이', '/ho-gi-sim-i/', '好奇心', '♪ 向著你的好奇心相遇', 0),
(90, 1, '만나서', '/man-na-seo/', '相遇', '♪ 向著你的好奇心相遇', 0),
(91, 1, '타올라', '/ta-ol-la/', '燃燒起來', '♪ 燃燒起來 正在燃燒', 0),
(92, 1, '타오른다', '/ta-o-reun-da/', '正在燃燒', '♪ 燃燒起來 正在燃燒', 0),
(93, 1, '쉽게', '/swip-ge/', '容易地', '♪ 稍微容易點說的話', 0),
(94, 1, '말하자면', '/mal-ha-ja-myeon/', '說起來', '♪ 稍微容易點說的話', 0),
(95, 1, '골라도', '/gol-la-do/', '就算挑選', '♪ 你選什麼都會遇到我', 0),
(96, 1, '만나게', '/man-na-ge/', '遇見', '♪ 你選什麼都會遇到我', 0),
(97, 1, '될', '/doel/', '將會', '♪ 你選什麼都會遇到我', 0),
(98, 1, '거야', '/geo-ya/', '的', '♪ 你選什麼都會遇到我', 0),
(99, 1, '황당하긴', '/hwang-dang-ha-gin/', '雖然荒唐', '♪ 雖然有點荒唐', 0),
(100, 1, '해도', '/hae-do/', '即使', '♪ 雖然有點荒唐', 0),
(101, 1, '억지라고', '/eok-ji-ra-go/', '就算牽強', '♪ 就算是強求', 0),
(102, 1, '절대', '/jeol-dae/', '絕對', '♪ 絕對不會讓你後悔', 0),
(103, 1, '후회하지', '/hu-hoe-ha-ji/', '後悔', '♪  絕對不會讓你後悔', 0),
(104, 1, '선명하게', '/seon-myeong-ha-ge/', '鮮明地', '♪ 再更鮮明地把你的心展現給我看', 0),
(105, 1, '내게', '/nae-ge/', '向我', '♪  再更鮮明地把你的心展現給我看', 0),
(106, 1, '보여봐', '/bo-yeo-bwa/', '展示看看', '♪  再更鮮明地把你的心展現給我看', 0),
(107, 1, '귀', '/gwi/', '耳朵', '♪ 耳朵 傾聽一下', 0),
(108, 1, '기울여봐', '/gi-ul-yeo-bwa/', '傾聽', '♪ 耳朵 傾聽一下', 0),
(109, 1, '무슨', '/mu-seun/', '什麼', '♪ 沒聽到什麼聲音嗎?', 0),
(110, 1, '소리가', '/so-ri-ga/', '聲音', '♪  沒聽到什麼聲音嗎?', 0),
(111, 1, '들리지', '/deul-li-ji/', '聽見', '♪  沒聽到什麼聲音嗎?', 0),
(112, 1, '않니', '/an-ni/', '不是嗎', '♪  沒聽到什麼聲音嗎?', 0),
(113, 1, '더', '/deo/', '更多', '♪ 再加上一個 yes or yes or yes', 0),
(114, 1, '보태서', '/bo-tae-seo/', '加上', '♪ 再加上一個 yes or yes or yes', 0),
(115, 1, '골拉봐', '/gol-la-bwa/', '挑選看看', '♪  挑選看看吧，來，選擇由你心', 0),
